                        ...
                        <View style={styles.container}>
                          ...
                          <Card isDarkMode={isDarkMode}>
                            <View style={styles.cardContainerContent}>
                                ...
                                <Text
                                    style={[styles.fieldText, { color: isDarkMode ? '#fff' : '#000'}]}
                                >Customer Name</Text>
                                ...
                                <TouchableOpacity 
                                    style={[styles.inputField, { borderColor: isDarkMode ? '#fff' : '#000'}]}
                                    onPress={showDatepicker}
                                >
                                    <Text style={[styles.inputText, { color: formattedDate ? '#000' : (isDarkMode ? '#5e5e5e' : '#aaa') }]}>
                                        {formattedDate || 'Select Order Date'}
                                    </Text>
                                </TouchableOpacity>
                                {showDatePicker && (
                                    <DateTimePicker
