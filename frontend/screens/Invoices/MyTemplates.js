...
const MyTemplates = () => {
    ...
    const fetchTemplates = async () => {
        try {
            if (!authState.accessToken) {
                console.log('No auth token available, skipping templates fetch');
                return;
            }
            ...
            console.log('Fetching templates from:', endpoints.templates);
            console.log('Using access token:', authState.accessToken.substring(0, 20) + '...');
            ...
            console.error('Detailed error fetching templates:', err);
